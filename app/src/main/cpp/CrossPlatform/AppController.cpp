...
{
// clang-format off
constexpr char licenseKey[] = "";
// clang-format on
...
AppController::createObservers()
{
    ...
    else
    {
        ...
        modelTargetConfig.databasePath = "lieutenant_DA.xml";
        modelTargetConfig.targetName = "lieutenant_DA";
