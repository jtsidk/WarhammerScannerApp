...
#include "CrossPlatform/Log.h" // <--- AÑADE ESTA LÍNEA (ajusta la ruta si es necesario)

#include "GLESUtils.h"
#include "Shaders.h"

#include <MemoryStream.h> // Asegúrate que este archivo es accesible
#include <Models.h>       // Asegúrate que este archivo es accesible

#include <android/asset_manager.h>
#include <vector> // Necesario para std::vector
#include <iterator> // Necesario para std::back_inserter
#include <algorithm>
